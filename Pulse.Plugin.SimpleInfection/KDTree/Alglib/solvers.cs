    ...
    public class linlsqr
    {
        ...
        *************************************************************************/
            ...
            double[] b)
        {
            ...
            ap.assert(apserv.isfinitevector(b, state.m), "LinLSQRSetB: B contains infinite or NaN values");
            state.bnorm2 = 0;
        ...
        *************************************************************************/
            ...
            double lambdai)
        {
            ...
            ap.assert(math.isfinite(lambdai) && (double)(lambdai)>=(double)(0), "LinLSQRSetLambdaI: LambdaI is infinite or NaN");
        ...
        *************************************************************************/
            ...
            double[] b)
        {
            ...
            ap.assert(apserv.isfinitevector(b, state.m), "LinLSQRSolveSparse: B contains infinite or NaN values");
        ...
        *************************************************************************/
            ...
            int maxits)
        {
            ...
            ap.assert(math.isfinite(epsa) && (double)(epsa)>=(double)(0), "LinLSQRSetCond: EpsA is negative, INF or NAN");
            ap.assert(math.isfinite(epsb) && (double)(epsb)>=(double)(0), "LinLSQRSetCond: EpsB is negative, INF or NAN");
    ...
    public class lincg
    {
        ...
        *************************************************************************/
            ...
            double[] x)
        {
            ...
            ap.assert(apserv.isfinitevector(x, state.n), "LinCGSetStartingPoint: X contains infinite or NaN values!");
            for(i_=0; i_<=state.n-1;i_++)
            {
        ...
        *************************************************************************/
            ...
            double[] b)
        {
            ...
            ap.assert(apserv.isfinitevector(b, state.n), "LinCGSetB: B contains infinite or NaN values!");
            for(i_=0; i_<=state.n-1;i_++)
            {
                state.b[i_] = b[i_];
            }
        ...
        *************************************************************************/
            ...
            int maxits)
        {
            ...
            ap.assert(math.isfinite(epsf) && (double)(epsf)>=(double)(0), "LinCGSetCond: EpsF is negative or contains infinite or NaN values");
