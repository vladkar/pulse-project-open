    ...
    public class optserv
    {
        ...
        *************************************************************************/
            ...
            int nslack)
        {
            ...
            for(i=0; i<=nmain-1; i++)
            {
                ap.assert((!havebl[i] || !havebu[i]) || (double)(bl[i])<=(double)(bu[i]), "ProjectGradientIntoBC: internal error (infeasible constraints)");
        ...
        *************************************************************************/
            ...
            ref double maxsteplen)
        {
            ...
            ap.assert((double)(alpha)!=(double)(0), "CalculateStepBound: zero alpha");
            variabletofreeze = -1;
            ...
            for(i=0; i<=nmain-1; i++)
            {
                ...
                {
                    ap.assert((double)(x[i])>=(double)(bndl[i]), "CalculateStepBound: infeasible X");
                    prevmax = maxsteplen;
                ...
                {
                    ap.assert((double)(x[i])<=(double)(bndu[i]), "CalculateStepBound: infeasible X");
                    prevmax = maxsteplen;
            ...
            for(i=0; i<=nslack-1; i++)
            {
                ...
                {
                    ap.assert((double)(x[nmain+i])>=(double)(0), "CalculateStepBound: infeasible X");
                    prevmax = maxsteplen;
        ...
        *************************************************************************/
            ...
            double maxsteplen)
        {
            ...
            ap.assert(variabletofreeze<0 || (double)(steptaken)<=(double)(maxsteplen));
        ...
        *************************************************************************/
            ...
            double droptol)
        {
            ...
            for(i=0; i<=nmain-1; i++)
            {
                ap.assert(!havebndl[i] || (double)(x[i])>=(double)(bndl[i]), "FilterDirection: infeasible point");
                ap.assert(!havebndu[i] || (double)(x[i])<=(double)(bndu[i]), "FilterDirection: infeasible point");
            ...
            for(i=0; i<=nslack-1; i++)
            {
                ap.assert((double)(x[nmain+i])>=(double)(0), "FilterDirection: infeasible point");
    ...
    public class cqmodels
    {
        ...
        *************************************************************************/
            ...
            double alpha)
        {
            ...
            ap.assert(math.isfinite(alpha) && (double)(alpha)>=(double)(0), "CQMSetA: Alpha<0 or is not finite number");
            ap.assert((double)(alpha)==(double)(0) || apserv.isfinitertrmatrix(a, s.n, isupper), "CQMSetA: A is not finite NxN matrix");
            s.alpha = alpha;
        ...
        *************************************************************************/
            ...
            double tau)
        {
            ...
            ap.assert(math.isfinite(tau) && (double)(tau)>=(double)(0), "CQMSetD: Tau<0 or is not finite number");
            ap.assert((double)(tau)==(double)(0) || apserv.isfinitevector(d, s.n), "CQMSetD: D is not finite Nx1 vector");
            s.tau = tau;
            if( (double)(tau)>(double)(0) )
            {
                ...
                for(i=0; i<=s.n-1; i++)
                {
                    ap.assert((double)(d[i])>=(double)(0), "CQMSetD: D[i]<0");
                    s.d[i] = d[i];
                }
            }
            s.ismaintermchanged = true;
        ...
        *************************************************************************/
            ...
            double[] b)
        {
            ...
            ap.assert(apserv.isfinitevector(b, s.n), "CQMSetB: B is not finite vector");
            apserv.rvectorsetlengthatleast(ref s.b, s.n);
            for(i=0; i<=s.n-1; i++)
            {
                s.b[i] = b[i];
        ...
        *************************************************************************/
            ...
            double theta)
        {
            ...
            ap.assert(k>=0, "CQMSetQ: K<0");
            ap.assert((k==0 || (double)(theta)==(double)(0)) || apserv.apservisfinitematrix(q, k, s.n), "CQMSetQ: Q is not finite matrix");
            ap.assert((k==0 || (double)(theta)==(double)(0)) || apserv.isfinitevector(r, k), "CQMSetQ: R is not finite vector");
            ap.assert(math.isfinite(theta) && (double)(theta)>=(double)(0), "CQMSetQ: Theta<0 or is not finite number");
        ...
        *************************************************************************/
            ...
            bool[] activeset)
        {
            ...
            ap.assert(ap.len(x)>=s.n, "CQMSetActiveSet: Length(X)<N");
            ap.assert(ap.len(activeset)>=s.n, "CQMSetActiveSet: Length(ActiveSet)<N");
            for(i=0; i<=s.n-1; i++)
            {
                ...
                if( activeset[i] )
                {
                    ap.assert(math.isfinite(x[i]), "CQMSetActiveSet: X[] contains infinite constraints");
        ...
        *************************************************************************/
            ...
            double[] x)
        {
            ...
            n = s.n;
            ap.assert(apserv.isfinitevector(x, n), "CQMEval: X is not finite vector");
            result = 0.0;
        ...
        *************************************************************************/
            ...
            ref double[] g)
        {
            ...
            n = s.n;
            ap.assert(apserv.isfinitevector(x, n), "CQMEvalGradUnconstrained: X is not finite vector");
        ...
        *************************************************************************/
            ...
            double[] x)
        {
            ...
            n = s.n;
            ap.assert(apserv.isfinitevector(x, n), "CQMDebugConstrainedEvalT: X is not finite vector");
            if( !cqmrebuild(s) )
            {
                result = Double.NaN;
                return result;
            ...
            for(i=0; i<=n-1; i++)
            {
                if( !s.activeset[i] )
                {
                    ap.assert(j<nfree, "CQMDebugConstrainedEvalT: internal error");
                    s.txc[j] = x[i];
                    j = j+1;
                }
            }
        ...
        *************************************************************************/
            ...
            double[] x)
        {
            ...
            n = s.n;
            ap.assert(apserv.isfinitevector(x, n), "CQMDebugConstrainedEvalE: X is not finite vector");
            if( !cqmrebuild(s) )
            {
                result = Double.NaN;
                return result;
            ...
            for(i=0; i<=n-1; i++)
            {
                if( !s.activeset[i] )
                {
                    ap.assert(j<nfree, "CQMDebugConstrainedEvalE: internal error");
                    s.txc[j] = x[i];
                    j = j+1;
                }
            }
            ...
            // ECA
            //
            ap.assert((s.ecakind==0 || s.ecakind==1) || (s.ecakind==-1 && nfree==0), "CQMDebugConstrainedEvalE: unexpected ECAKind");
            if( s.ecakind==0 )
            {
        ...
        *************************************************************************/
        private static bool cqmrebuild(convexquadraticmodel s)
        {
            ...
            if( ((((s.isactivesetchanged || s.ismaintermchanged) || s.issecondarytermchanged) && s.k>0) && (double)(s.theta)>(double)(0)) && nfree>0 )
            {
                ...
                ap.assert(s.ecakind==0 || s.ecakind==1, "CQMRebuild: unexpected ECAKind");
                if( s.ecakind==0 )
                {
        ...
        *************************************************************************/
            ...
            ref double[] tmp)
        {
            ...
            ap.assert((s.ecakind==0 || s.ecakind==1) || (s.ecakind==-1 && s.nfree==0), "CQMSolveEA: unexpected ECAKind");
            if( s.ecakind==0 )
            {
    ...
    public class snnls
    {
        ...
        *************************************************************************/
            ...
            int nr)
        {
            ...
            ap.assert(nd>=0, "SNNLSSetProblem: ND<0");
            ap.assert(ns>=0, "SNNLSSetProblem: NS<0");
            ap.assert(nr>0, "SNNLSSetProblem: NR<=0");
            ap.assert(ns<=nr, "SNNLSSetProblem: NS>NR");
            ap.assert(ap.rows(a)>=nr || nd==0, "SNNLSSetProblem: rows(A)<NR");
            ap.assert(ap.cols(a)>=nd, "SNNLSSetProblem: cols(A)<ND");
            ap.assert(ap.len(b)>=nr, "SNNLSSetProblem: length(B)<NR");
            ap.assert(apserv.apservisfinitematrix(a, nr, nd), "SNNLSSetProblem: A contains INF/NAN");
            ap.assert(apserv.isfinitevector(b, nr), "SNNLSSetProblem: B contains INF/NAN");
        ...
        *************************************************************************/
        public static void snnlsdropnnc(snnlssolver s,
            int idx)
        {
            ap.assert(idx>=0, "SNNLSDropNNC: Idx<0");
            ap.assert(idx<s.ns+s.nd, "SNNLSDropNNC: Idx>=NS+ND");
            s.nnc[idx] = false;
        }
    ...
    public class sactivesets
    {
        ...
        *************************************************************************/
            ...
            double[] s)
        {
            ...
            ap.assert(state.algostate==0, "SASSetScale: you may change scale only in modification mode");
            ap.assert(ap.len(s)>=state.n, "SASSetScale: Length(S)<N");
            for(i=0; i<=state.n-1; i++)
            {
                ap.assert(math.isfinite(s[i]), "SASSetScale: S contains infinite or NAN elements");
                ap.assert((double)(s[i])!=(double)(0), "SASSetScale: S contains zero elements");
            }
            for(i=0; i<=state.n-1; i++)
            {
        ...
        *************************************************************************/
            ...
            double[] d)
        {
            ...
            ap.assert(state.algostate==0, "SASSetPrecDiag: you may change preconditioner only in modification mode");
            ap.assert(ap.len(d)>=state.n, "SASSetPrecDiag: D is too short");
            for(i=0; i<=state.n-1; i++)
            {
                ap.assert(math.isfinite(d[i]), "SASSetPrecDiag: D contains infinite or NAN elements");
                ap.assert((double)(d[i])>(double)(0), "SASSetPrecDiag: D contains non-positive elements");
            }
            for(i=0; i<=state.n-1; i++)
            {
                state.h[i] = d[i];
        ...
        *************************************************************************/
            ...
            double[] bndu)
        {
            ...
            ap.assert(state.algostate==0, "SASSetBC: you may change constraints only in modification mode");
            n = state.n;
            ap.assert(ap.len(bndl)>=n, "SASSetBC: Length(BndL)<N");
            ap.assert(ap.len(bndu)>=n, "SASSetBC: Length(BndU)<N");
            for(i=0; i<=n-1; i++)
            {
                ap.assert(math.isfinite(bndl[i]) || Double.IsNegativeInfinity(bndl[i]), "SASSetBC: BndL contains NAN or +INF");
                ap.assert(math.isfinite(bndu[i]) || Double.IsPositiveInfinity(bndu[i]), "SASSetBC: BndL contains NAN or -INF");
                state.bndl[i] = bndl[i];
        ...
        *************************************************************************/
            ...
            int k)
        {
            ...
            ap.assert(state.algostate==0, "SASSetLC: you may change constraints only in modification mode");
            n = state.n;
            
            //
            // First, check for errors in the inputs
            //
            ap.assert(k>=0, "SASSetLC: K<0");
            ap.assert(ap.cols(c)>=n+1 || k==0, "SASSetLC: Cols(C)<N+1");
            ap.assert(ap.rows(c)>=k, "SASSetLC: Rows(C)<K");
            ap.assert(ap.len(ct)>=k, "SASSetLC: Length(CT)<K");
            ap.assert(apserv.apservisfinitematrix(c, k, n+1), "SASSetLC: C contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            int nic)
        {
            ...
            ap.assert(state.algostate==0, "SASSetLCX: you may change constraints only in modification mode");
            n = state.n;
            
            //
            // First, check for errors in the inputs
            //
            ap.assert(nec>=0, "SASSetLCX: NEC<0");
            ap.assert(nic>=0, "SASSetLCX: NIC<0");
            ap.assert(ap.cols(cleic)>=n+1 || nec+nic==0, "SASSetLCX: Cols(CLEIC)<N+1");
            ap.assert(ap.rows(cleic)>=nec+nic, "SASSetLCX: Rows(CLEIC)<NEC+NIC");
            ap.assert(apserv.apservisfinitematrix(cleic, nec+nic, n+1), "SASSetLCX: CLEIC contains infinite or NaN values!");
        ...
        *************************************************************************/
            ...
            double[] x)
        {
            ...
            ap.assert(state.algostate==0, "SASStartOptimization: already in optimization mode");
            result = false;
            n = state.n;
            nec = state.nec;
            nic = state.nic;
        ...
        *************************************************************************/
            ...
            ref double vval)
        {
            ...
            ap.assert(state.algostate==1, "SASExploreDirection: is not in optimization mode");
            n = state.n;
            nec = state.nec;
            nic = state.nic;
            cidx = -1;
            ...
            for(i=0; i<=n-1; i++)
            {
                ...
                {
                    ap.assert(!state.hasbndl[i] || (double)(state.xc[i])>=(double)(state.bndl[i]), "SASExploreDirection: internal error - infeasible X");
                    ap.assert(!state.hasbndu[i] || (double)(state.xc[i])<=(double)(state.bndu[i]), "SASExploreDirection: internal error - infeasible X");
        ...
        *************************************************************************/
            ...
            double cval)
        {
            ...
            ap.assert(state.algostate==1, "SASMoveTo: is not in optimization mode");
            n = state.n;
            nec = state.nec;
            nic = state.nic;
            ...
            if( needact )
            {
                ...
                // Activation
                //
                ap.assert(cidx>=0 && cidx<n+nec+nic, "SASMoveTo: incorrect CIdx");
                if( cidx<n )
                {
        ...
        *************************************************************************/
        public static void sasconstraineddescent(sactiveset state,
            ...
            ref double[] d)
        {
            ap.assert(state.algostate==1, "SASConstrainedDescent: is not in optimization mode");
        ...
        *************************************************************************/
        public static void sasconstraineddescentprec(sactiveset state,
            ...
            ref double[] d)
        {
            ap.assert(state.algostate==1, "SASConstrainedDescentPrec: is not in optimization mode");
            sasrebuildbasis(state);
        ...
        *************************************************************************/
            ...
            ref double[] d)
        {
            ...
            ap.assert(state.algostate==1, "SASConstrainedAntigradientPrec: is not in optimization mode");
            sasrebuildbasis(state);
        ...
        *************************************************************************/
            ...
            ref double penalty)
        {
            ...
            ap.assert(state.algostate==1, "SASCorrection: is not in optimization mode");
            sasrebuildbasis(state);
            n = state.n;
        ...
        *************************************************************************/
            ...
            double[] x)
        {
            ...
            ap.assert(state.algostate==1, "SASActiveLCPenalty1: is not in optimization mode");
            sasrebuildbasis(state);
            n = state.n;
            nec = state.nec;
            nic = state.nic;
        ...
        *************************************************************************/
        public static void sasreactivateconstraints(sactiveset state,
            double[] gc)
        {
            ap.assert(state.algostate==1, "SASReactivateConstraints: must be in optimization mode");
        ...
        *************************************************************************/
        public static void sasreactivateconstraintsprec(sactiveset state,
            double[] gc)
        {
            ap.assert(state.algostate==1, "SASReactivateConstraintsPrec: must be in optimization mode");
        ...
        *************************************************************************/
            ...
            ref double[] d)
        {
            ...
            ap.assert(state.algostate==1, "SAS: internal error in ConstrainedDescent() - not in optimization mode");
            ap.assert(state.basisisready, "SAS: internal error in ConstrainedDescent() - no basis");
            n = state.n;
    ...
    public class mincg
    {
        ...
        *************************************************************************/
        public static void mincgsetgradientcheck(mincgstate state,
            double teststep)
        {
            ap.assert(math.isfinite(teststep), "MinCGSetGradientCheck: TestStep contains NaN or Infinite");
            ap.assert((double)(teststep)>=(double)(0), "MinCGSetGradientCheck: invalid argument TestStep(TestStep<0)");
    ...
    public class minbleic
    {
        ...
        *************************************************************************/
            ...
            int k)
        {
            ...
            ap.assert(ap.cols(c)>=n+1 || k==0, "MinBLEICSetLC: Cols(C)<N+1");
            ap.assert(ap.rows(c)>=k, "MinBLEICSetLC: Rows(C)<K");
            ap.assert(ap.len(ct)>=k, "MinBLEICSetLC: Length(CT)<K");
            ap.assert(apserv.apservisfinitematrix(c, k, n+1), "MinBLEICSetLC: C contains infinite or NaN values!");
        ...
        *************************************************************************/
        public static void minbleicsetcond(minbleicstate state,
            ...
            int maxits)
        {
            ap.assert(math.isfinite(epsg), "MinBLEICSetCond: EpsG is not finite number");
            ap.assert((double)(epsg)>=(double)(0), "MinBLEICSetCond: negative EpsG");
            ap.assert(math.isfinite(epsf), "MinBLEICSetCond: EpsF is not finite number");
            ap.assert((double)(epsf)>=(double)(0), "MinBLEICSetCond: negative EpsF");
            ap.assert(math.isfinite(epsx), "MinBLEICSetCond: EpsX is not finite number");
            ap.assert((double)(epsx)>=(double)(0), "MinBLEICSetCond: negative EpsX");
            ap.assert(maxits>=0, "MinBLEICSetCond: negative MaxIts!");
            if( (((double)(epsg)==(double)(0) && (double)(epsf)==(double)(0)) && (double)(epsx)==(double)(0)) && maxits==0 )
            {
                epsx = 1.0E-6;
            }
        ...
        *************************************************************************/
        ...
        lbl_44:
            ...
            ap.assert(!state.hasbndl[i] || (double)(state.sas.xc[i])>=(double)(state.bndl[i]), "MinBLEICIteration: internal error(State.X is out of bounds)");
            ap.assert(!state.hasbndu[i] || (double)(state.sas.xc[i])<=(double)(state.bndu[i]), "MinBLEICIteration: internal error(State.X is out of bounds)");
            v = state.x[i];
            state.x[i] = v-state.teststep*state.s[i];
            if( state.hasbndl[i] )
            {
        ...
        *************************************************************************/
        public static void minbleicsetgradientcheck(minbleicstate state,
            double teststep)
        {
            ap.assert(math.isfinite(teststep), "MinBLEICSetGradientCheck: TestStep contains NaN or Infinite");
            ap.assert((double)(teststep)>=(double)(0), "MinBLEICSetGradientCheck: invalid argument TestStep(TestStep<0)");
            state.teststep = teststep;
        }
    ...
    public class minlbfgs
    {
        ...
        *************************************************************************/
        public static void minlbfgssetgradientcheck(minlbfgsstate state,
            double teststep)
        {
            ap.assert(math.isfinite(teststep), "MinLBFGSSetGradientCheck: TestStep contains NaN or Infinite");
            ap.assert((double)(teststep)>=(double)(0), "MinLBFGSSetGradientCheck: invalid argument TestStep(TestStep<0)");
            state.teststep = teststep;
        }
    ...
    public class minqp
    {
        ...
        *************************************************************************/
            ...
            bool isupper)
        {
            ...
            n = state.n;
            ap.assert(sparse.sparsegetnrows(a)>=n, "MinQPSetQuadraticTermSparse: Rows(A)<N");
            ap.assert(sparse.sparsegetncols(a)>=n, "MinQPSetQuadraticTermSparse: Cols(A)<N");
        ...
        *************************************************************************/
            ...
            double[] s)
        {
            ...
            ap.assert(ap.len(s)>=state.n, "MinQPSetScale: Length(S)<N");
            for(i=0; i<=state.n-1; i++)
            {
                ap.assert(math.isfinite(s[i]), "MinQPSetScale: S contains infinite or NAN elements");
                ap.assert((double)(s[i])!=(double)(0), "MinQPSetScale: S contains zero elements");
                state.s[i] = Math.Abs(s[i]);
            }
        }
        ...
        *************************************************************************/
        public static void minqpsetalgobleic(minqpstate state,
            ...
            int maxits)
        {
            ap.assert(math.isfinite(epsg), "MinQPSetAlgoBLEIC: EpsG is not finite number");
            ap.assert((double)(epsg)>=(double)(0), "MinQPSetAlgoBLEIC: negative EpsG");
            ap.assert(math.isfinite(epsf), "MinQPSetAlgoBLEIC: EpsF is not finite number");
            ap.assert((double)(epsf)>=(double)(0), "MinQPSetAlgoBLEIC: negative EpsF");
            ap.assert(math.isfinite(epsx), "MinQPSetAlgoBLEIC: EpsX is not finite number");
            ap.assert((double)(epsx)>=(double)(0), "MinQPSetAlgoBLEIC: negative EpsX");
            ap.assert(maxits>=0, "MinQPSetAlgoBLEIC: negative MaxIts!");
            state.algokind = 2;
            if( (((double)(epsg)==(double)(0) && (double)(epsf)==(double)(0)) && (double)(epsx)==(double)(0)) && maxits==0 )
            {
                epsx = 1.0E-6;
        ...
        *************************************************************************/
            ...
            int k)
        {
            ...
            // First, check for errors in the inputs
            //
            ap.assert(k>=0, "MinQPSetLC: K<0");
            ap.assert(ap.cols(c)>=n+1 || k==0, "MinQPSetLC: Cols(C)<N+1");
            ap.assert(ap.rows(c)>=k, "MinQPSetLC: Rows(C)<K");
            ap.assert(ap.len(ct)>=k, "MinQPSetLC: Length(CT)<K");
            ap.assert(apserv.apservisfinitematrix(c, k, n+1), "MinQPSetLC: C contains infinite or NaN values!");
        ...
        *************************************************************************/
        public static void minqpoptimize(minqpstate state)
        {
            ...
            if( state.algokind==2 )
            {
                ap.assert(state.akind==0 || state.akind==1, "MinQPOptimize: unexpected AKind");
                    ...
                    if( state.solver.lsstart )
                    {
                        ...
                        if( !state.solver.lbfgssearch && (double)(d2)>=(double)(0) )
                        {
                            ...
                            if( (double)(d2)>(double)(0) )
                            {
                                ...
                                ap.assert((double)(v)>(double)(0), "MinQPOptimize: inernal errror (scaled direction is zero)");
                                v = 1/Math.Sqrt(v);
                                for(i_=0; i_<=n-1;i_++)
                                {
    ...
    public class minlm
    {
        ...
        *************************************************************************/
        ...
        lbl_21:
            ...
            ap.assert((state.havebndl[i] && (double)(state.bndl[i])<=(double)(state.x[i])) || !state.havebndl[i], "MinLM: internal error(State.X is out of bounds)");
            ap.assert((state.havebndu[i] && (double)(state.x[i])<=(double)(state.bndu[i])) || !state.havebndu[i], "MinLMIteration: internal error(State.X is out of bounds)");
            v = state.x[i];
            state.x[i] = v-state.teststep*state.s[i];
            if( state.havebndl[i] )
            {
        ...
        *************************************************************************/
        public static void minlmsetgradientcheck(minlmstate state,
            double teststep)
        {
            ap.assert(math.isfinite(teststep), "MinLMSetGradientCheck: TestStep contains NaN or Infinite");
            ap.assert((double)(teststep)>=(double)(0), "MinLMSetGradientCheck: invalid argument TestStep(TestStep<0)");
            state.teststep = teststep;
        }
