...
{
    public class VkfestStageBugProbeRole : DecisionTreeRole
    {
        public VkfestStageBugProbeRole(AbstractPulseAgent agent) : base
            (
                agent, 
                new SimpleScheduleRoleConfig {CornerCutOffRadius = 0.2, PoiInteractionRadius = 0.5, DeadZoneRadius = 0.3}, 
                "VkFest Obstacle bug Probe Agent Role", 
                IdUtil.NextRandomId()
            )
        {
            //
...
//            var selectPoi = new PoiSelectTask(ad);
            ...
            {
                _agent.DesiredPosition = new PulseVector2(15, 150);
